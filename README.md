...
This is a project template for a greenfield Java project. It's named after Marvin the paranoid android from the
Hitchhiker's Guide to the Galaxy. Given below are instructions on how
to use it.
...
4. After that, locate the `src/main/java/marvin/Launcher.java` file, right-click it, and choose `Run Launcher.main()` (
